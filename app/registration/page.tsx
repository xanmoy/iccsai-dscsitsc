...
import { CreditCard, Calendar, Info, FileText, AlertCircle, CheckCircle } from "lucide-react"
      ...
      <div className="container mx-auto max-w-5xl px-4 py-12">
        ...
        >
          <motion.div variants={fadeIn} className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-primary">Registration Information</h2>
          </motion.div>

          <motion.div variants={fadeIn} className="bg-card rounded-xl p-8 border mb-8">
            ...
            <div className="flex items-center gap-3 mt-6 p-4 bg-primary/5 rounded-lg border border-primary/20">
              ...
              <p className="font-semibold text-lg">Registration Deadline: August 16, 2025</p>
            </div>
          </motion.div>
        </motion.section>
        ...
        >
          <motion.div variants={fadeIn} className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-primary">Registration Fees</h2>
          </motion.div>

          <motion.div variants={fadeIn} className="overflow-hidden rounded-xl border">
            <Table>
              <TableCaption className="pb-4">All fees are in INR (₹) and USD ($)</TableCaption>
              <TableHeader className="bg-muted/50">
                <TableRow>
                  <TableHead className="w-[250px] text-base">Category</TableHead>
                  <TableHead className="text-base">Indian Participant (INR)</TableHead>
                  <TableHead className="text-base">Foreign Author (USD)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
        ...
        >
          <motion.div variants={fadeIn} className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-primary">Registration Process</h2>
          </motion.div>

          <motion.div
            variants={fadeIn}
            className="flex flex-col items-center justify-center py-16 border rounded-xl text-center"
          >
        ...
        >
          <motion.div variants={fadeIn} className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-primary">Registration Policies</h2>
          </motion.div>
          ...
          <motion.div variants={fadeIn} className="space-y-6">
            <div className="flex gap-4 p-6 border rounded-lg hover:border-primary/50 transition-colors">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">Author Registration</h3>
                <p>
                  At least one author of each accepted paper must register at the full rate (academic or industry) to
                  have the paper included in the conference proceedings.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 border rounded-lg hover:border-primary/50 transition-colors">
              ...
              <div>
                ...
                <p>
                  Cancellations received before August 15, 2025 will receive a refund with 50% of the registration fee.
                  No refunds will be issued for cancellations after August 15, 2025.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 border rounded-lg hover:border-primary/50 transition-colors">
              ...
              <div>
                ...
                <p>
                  Students must provide proof of student status (student ID or letter from their institution) during the
                  registration process.
                </p>
              </div>
            </div>
        ...
        >
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl p-8 md:p-12 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Ready to Register?</h2>
